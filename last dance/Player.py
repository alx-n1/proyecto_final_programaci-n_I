...
class Player():
    def __init__(self, ancho_image, alto_image, canvas, window):
        ...
        self.y_inicial = self.alto_image - self.alto_player - 30
        ...
        self.bullet_image = PilImage.open('disparo2.png')
        self.bullet_resize_image = self.bullet_image.resize((35, 45), PilImage.LANCZOS)

...
class Main_game_level(tk.Tk):
    def __init__(self):
        ...
        self.load_gif('Main_game/gif_fondo.gif')
    ...
    def create_enemies(self):
        ...
        y = 50
        for i in range(48):
            gif_paths = ["Main_game/enemies/enemy1.gif", 
                        "Main_game/enemies/enemy2.gif", 
                        "Main_game/enemies/enemy3.gif"]
            if i % 12 == 0:
                counter_for_x = 0
